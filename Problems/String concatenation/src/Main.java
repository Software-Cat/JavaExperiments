...
class CurryConcat {
    ...
    public static String calc(String str1, String str2, String str3, String str4) {
        ...
        Function<String, Function<String, Function<String, Function<String, String>>>> stringFun = a -> b -> c -> d -> {
            return a.toLowerCase() + c.toUpperCase() + b.toLowerCase() + d.toUpperCase();
        };
